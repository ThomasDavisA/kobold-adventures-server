...
VALUES 
    ...
    (7, 'Meditate at the beach.', 
        'Mana', 10, 
        'You meditate at the beach.', 
        'You mess up mediation and get nothing.'),
    (7, 'Study the Beach!', 
        'Intellect', 10, 
        'You discover the beach is a magical construct!', 
        'You discover shiny pebbles.'),
    (7, 'Dance!', 
        'Eloquence', 10, 
    ...
    (7, 'Fix the Shrine up.', 
        ...
        'Placeholder Success', 
        'Placeholder Failure'),
    (7, 'Climb the fence before he does!', 
        'Fitness', 20, 
        'Placeholder Success', 
        'Placeholder Failure'),
    (7, 'Use magic to stop him!', 
        'Mana', 20, 
        'Placeholder Success', 
        'Placeholder Failure'),
    (7, 'Find a shortcut to cut him off!', 
        'Intellect', 20, 
        'Placeholder Success', 
        'Placeholder Failure'),
    (7, 'Talk him down!', 
    ...
    (7, 'Run around!', 
        ...
        'Placeholder Success', 
        'Placeholder Failure'),
    (7, 'Practice some magic.', 
        'Mana', 20, 
        'Placeholder Success', 
        'Placeholder Failure'),
    (7, 'Study the alleyway.', 
        'Intellect', 20, 
        'Placeholder Success', 
        'Placeholder Failure'),
    (7, 'Dance!', 
